      ...
      <div class="wrap">
        ...
        <van-list v-model="loading" :finished="finished" finished-text="没有更多了" @load="onLoad">
          ...
          <div class="ul-card" v-for="(m ,i) in byList" :key="i">
            ...
            <ul class="item">
              <li v-for="b in m?.articles" :key="b.id" @click="$router.push({path:'/say' , query:{id:b.id}})">
                <div class="card">
                  <img :src="`${b.cover}`" alt />
                  <div class="title">
                    <p>{{b.title}}</p>
...
<script>
// https://apis.netstart.cn/one/find/bymonth/3/2022-10
...
export default {
  ...
  methods: {
    ...
    getMonthArtics(date) {
      ...
      this.$axios(`https://apis.netstart.cn/one/find/bymonth/3/${date}`).then(
        ({ data }) => {
