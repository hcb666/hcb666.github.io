$(function (window, $) {
    ...
    DragMenu.prototype.setOffset = function () { // 鍒濆璧嬪€�
        var _this = this;
        var lis = this.getLis();
    ...
    DragMenu.prototype.getLis = function () { // 鑾峰彇lis鍏冪礌
        return $(this.container).find('li');
    }

    DragMenu.prototype.getMin = function (node) { // 姹傚嚭璺濈鏈€杩戠殑鍏冪礌
        var _this = this;
        var lis = this.getLis();
        var index = null;
        var minDis = Infinity;
    ...
    DragMenu.prototype.crashTest = function (node1, node2) { // 纰版挒妫€娴�
    ...
    DragMenu.prototype.calcDistance = function (node1, node2) { // 璁＄畻鍑鸿窛绂�
        var a = node1.offsetLeft - node2.offsetLeft;
        var b = node1.offsetTop - node2.offsetTop;
        return Math.sqrt(Math.pow(a, 2) + Math.pow(b, 2));
    }

    DragMenu.prototype.move = function (node, json) { // 绉诲姩
        var _this = this;
    ...
    DragMenu.prototype.bindEvent = function (node) { // 浜嬩欢缁戝畾
        var _this = this;
